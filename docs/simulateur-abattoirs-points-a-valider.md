...
**Statut** : à valider (en lien avec TODO 2)
...
**Statut** : à valider (décision provisoire prise)
...
**Statut** : à valider (recommandation prise)
...
|---|---|---|
| 1 | 35 cas FR_document vide pour ZRII MR-PPA + ovale diagonales | LPS non requis (à confirmer) |
| 2 | 195 cas UE_document vide pour zone indemne/ZRI + non MCA + abattoir ZRI/ZRII/ZRIII | Dérogation à la certification possible (à confirmer) |
| 3 | Condition MCA inversée DOCX vs Grist pour la dérogation | Suivre DOCX (à valider) |
| 4 | Libellé « Dérogation … obligatoire » vs « … possible » | Possible (à confirmer) |
